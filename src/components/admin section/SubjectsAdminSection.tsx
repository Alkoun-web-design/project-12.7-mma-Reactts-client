...
const SubjectsAdminSection: React.FC<AdminSectionProps> = ({
  ...
  const [data, setData] = useState<Subject[]>([]);
                ...
                const [form, setForm] = useState<SubjectForm>(blankForm);
  ...
  <div className="w-full bg-white rounded-lg shadow p-8">
    ...
    {data && ( 
      ...
      {id && <button type="button" className="btn btn-secondary btn-sm" onClick={() => { setId(null); setForm(blankForm)}}>Cancel</button>}
    </form>
